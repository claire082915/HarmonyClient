...
mpirun -n 5 -bind-to none ./release/bin/query --benchmarks_path ./benchmarks --dataset msong  --mode block --block=8
mpirun -n 5 -bind-to none ./release/bin/query --benchmarks_path ./benchmarks --dataset msong  --mode base 
```
...
Optional arguments:
  ...
  --warmup_list               how many lists are used to warmup heap [nargs=0..1] [default: 10]
  --disablePruning            set pruning disabled 
  --minorCut                  set minor pruning enabled 
  ...
  --mode                      The mode of search [nargs=0..1] [default: "group"]
  --HardInBalance             enable hard inBalance 
  --HardInBalanceRatio        control how inbalanced the search would be, 0.0 is perfectly balanced [nargs=0..1] [default: 0]
  --HardInBalanceTeamRatio    control how inbalanced the search would be, 0.0 is perfectly balanced [nargs=0..1] [default: 0]
  --HardInBalanceTeam         number of Hard InBalance Team [nargs=0..1] [default: 0]
  --brute_force_search_ratio  [nargs=0..1] [default: 1]
```
